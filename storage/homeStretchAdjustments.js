...
function readPayload() {
  ...
  try {
    ...
    throw new Error(`Unable to read Home Stretch adjustments: ${error.message}`);
  }
}

function loadHomeStretchAdjustments() {
  return readPayload().entries;
}

function getHomeStretchAdjustmentsData() {
  return readPayload();
}

function saveHomeStretchAdjustments(entries) {
